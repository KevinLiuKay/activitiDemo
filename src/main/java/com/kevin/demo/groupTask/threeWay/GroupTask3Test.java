...
public class GroupTask3Test {
	...
	public void deploymentProcessDefinition_inputStream() throws Exception{
		...
		//获取上传文件输入流程 
		InputStream inputStreamBpmn = this.getClass().getResourceAsStream("groupTask3.bpmn");
		InputStream inputStreamPng = this.getClass().getResourceAsStream("groupTask3.png");
		//获取仓库服务，从类路径下完成部署
		Deployment deployment = processEngine.getRepositoryService() //与流程定义和部署对象相关的Service
												...
												.deploy();//完成部署
		System.out.println("部署ID:" + deployment.getId());	//部署ID:8001
	...
	public void startProcess () throws Exception{
		...
		System.out.println("流程实例ID:" + pi.getId());//流程实例ID:8101
		System.out.println("流程定义ID:"+ pi.getProcessDefinitionId());	//流程定义ID: groupTask3:3:8004
	}
