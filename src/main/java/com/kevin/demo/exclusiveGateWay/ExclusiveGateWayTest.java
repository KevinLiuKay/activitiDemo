package com.kevin.demo.exclusiveGateWay;
...
public class ExclusiveGateWayTest {
	...
	public void deploymentProcessDefinition_inputStream() throws Exception{
		...
		Deployment deployment = processEngine.getRepositoryService() //与流程定义和部署对象相关的Service
												...
												.deploy();//完成部署
		System.out.println("部署ID:" + deployment.getId());	//3101
		System.out.println("部署名称:" + deployment.getName());//排他网关
	}
	...
	public void startProcess () throws Exception{
		...
		System.out.println("流程实例ID:" + pi.getId());//流程实例ID:3201
		System.out.println("流程定义ID:"+ pi.getProcessDefinitionId());	//流程定义ID: exclusiveGateWay:1:3104
	}
