package com.kevin.demo.sequenceFlow;
...
public class SequenceFlowTest {
	...
	public void deploymentProcessDefinition_inputStream() throws Exception{
		...
		System.out.println("部署名称:" + deployment.getName());//流程连线
	}
	...
	public void startProcess () throws Exception{
		...
		System.out.println("流程实例ID:" + pi.getId());//流程实例ID 2601
		System.out.println("流程定义ID:"+ pi.getProcessDefinitionId());	//流程定义ID:    sequenceFlow:1:2504
	}
