package com.kevin.demo.personalTask.oneWay;
...
public class TaskTest {
	...
	public void deploymentProcessDefinition_inputStream() throws Exception{
		...
		Deployment deployment = processEngine.getRepositoryService() //与流程定义和部署对象相关的Service
												...
												.deploy();//完成部署
		System.out.println("部署ID:" + deployment.getId());	//部署ID:5101
		System.out.println("部署名称:" + deployment.getName());//部署名称:任务
	}
	...
	public void startProcess () throws Exception{
		...
		System.out.println("流程实例ID:" + pi.getId());//流程实例ID:5201
		System.out.println("流程定义ID:"+ pi.getProcessDefinitionId());	//流程定义ID: task:1:5104
	}
